        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                ...
                <div class="col-10">
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <h1>Các bộ phim thuộc thể loại <?= $_SESSION["theloai"] ?></h1>
                        </div>
                    </div>
                    <div class="row pb-4">
                        <div class="col-10">
                        ...
                        <div class="add_data col-2">
                            <a class="btn btn-primary" href="../controller/film.php?add-film">
                                ...
                                foreach($films as $film){
                                    ...
                                    <tr id="<?=$film['id']?>">
                                        ...
                                        <td class="text-primary">
                                            <a href="../controller/film.php?id=<?=$film['id']?>" onclick="">View</a>
                                        </td>
                                        <td class="text-primary">
                                            <a href="../controller/film.php?update-id=<?=$film['id']?>" onclick="">Update</a>
                                        </td>
                                        <td class="text-primary">
                                            <a href="../controller/film.php?delete-id=<?=$film['id']?>" onclick="">Delete</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
